...
namespace Ahed_project.MasterData.Overall
{
    public class OverallFull : INotifyPropertyChanged
    {
        ...
        private string _nozzles_number_of_parallel_lines_tube_side;
        ...
        public string nozzles_number_of_parallel_lines_tube_side { get => _nozzles_number_of_parallel_lines_tube_side; set { _nozzles_number_of_parallel_lines_tube_side = value; OnPropertyChanged(nameof(nozzles_number_of_parallel_lines_tube_side)); } }
