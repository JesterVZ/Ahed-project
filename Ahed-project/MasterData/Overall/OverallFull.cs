...
namespace Ahed_project.MasterData.Overall
{
    public class OverallFull:INotifyPropertyChanged
    {
        ...
        public string pressure_drop_shell_side_inlet_nozzles_pV { get => pressure_drop_shell_side_inlet_nozzles_pV; set { _pressure_drop_shell_side_inlet_nozzles_pV = value;  OnPropertyChanged(nameof(pressure_drop_shell_side_inlet_nozzles_pV));  }  }
        ...
        public string pressure_drop_shell_side_outlet_nozzles_pV { get => pressure_drop_shell_side_outlet_nozzles_pV; set { _pressure_drop_shell_side_outlet_nozzles_pV = value;  OnPropertyChanged(nameof(pressure_drop_shell_side_outlet_nozzles_pV));  }  }
