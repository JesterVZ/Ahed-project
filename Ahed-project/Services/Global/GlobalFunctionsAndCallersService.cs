...
namespace Ahed_project.Services.Global
{
    ...
    public class GlobalFunctionsAndCallersService
    {
        ...
        public static async void CalculateGeometry(GeometryFull geometry)
        {
            ...
            var geom = _geometryPageViewModel.Geometry;
            string json = JsonConvert.SerializeObject(new
            {
                head_exchange_type = geom.head_exchange_type,
                name = geom.name,
                outer_diameter_inner_side = geom.outer_diameter_inner_side,
                outer_diameter_tubes_side = geom.outer_diameter_tubes_side,
                outer_diameter_shell_side = geom.outer_diameter_shell_side,
                thickness_inner_side = geom.thickness_inner_side,
                thickness_tubes_side = geom.thickness_tubes_side,
                thickness_shell_side = geom.thickness_shell_side,
                material_tubes_side = geom.material_tubes_side,
                material_shell_side = geom.material_shell_side,
                number_of_tubes = geom.number_of_tubes,
                tube_inner_length = geom.tube_inner_length,
                orientation = geom.orientation,
                tube_profile_tubes_side = geom.tube_profile_tubes_side,
                roughness_tubes_side = geom.roughness_tubes_side,
                roughness_shell_side = geom.roughness_shell_side,
                bundle_type = geom.bundle_type,
                roller_expanded = geom.roller_expanded,
                nozzles_in_outer_diam_inner_side = geom.nozzles_in_outer_diam_inner_side,
                nozzles_in_outer_diam_tubes_side = geom.nozzles_in_outer_diam_tubes_side,
                nozzles_in_outer_diam_shell_side = geom.nozzles_in_outer_diam_shell_side,
                nozzles_in_thickness_inner_side = geom.nozzles_in_thickness_inner_side,
                nozzles_in_thickness_tubes_side = geom.nozzles_in_thickness_tubes_side,
                nozzles_in_thickness_shell_side = geom.nozzles_in_thickness_shell_side,
                nozzles_in_length_tubes_side = String.Empty,
                nozzles_in_length_shell_side = String.Empty,
                nozzles_out_outer_diam_inner_side = geom.nozzles_out_outer_diam_inner_side,
                nozzles_out_outer_diam_tubes_side = geom.nozzles_out_outer_diam_tubes_side,
                nozzles_out_outer_diam_shell_side = geom.nozzles_out_outer_diam_shell_side,
                nozzles_out_thickness_inner_side = geom.nozzles_out_thickness_inner_side,
                nozzles_out_thickness_tubes_side = geom.nozzles_out_thickness_tubes_side,
                nozzles_out_thickness_shell_side = geom.nozzles_out_thickness_shell_side,
                nozzles_out_length_tubes_side = String.Empty,
                nozzles_out_length_shell_side = String.Empty,
                nozzles_number_of_parallel_lines_tubes_side = geom.nozzles_number_of_parallel_lines_tubes_side,
                nozzles_number_of_parallel_lines_shell_side = geom.nozzles_number_of_parallel_lines_shell_side,
                shell_nozzle_orientation = geom.shell_nozzle_orientation,
                tube_plate_layout_tube_pitch = String.Empty,
                tube_plate_layout_tube_layout = geom.tube_plate_layout_tube_layout,
                tube_plate_layout_number_of_passes = geom.tube_plate_layout_number_of_passes,
                tube_plate_layout_div_plate_layout = geom.tube_plate_layout_div_plate_layout,
                tube_plate_layout_sealing_type = geom.tube_plate_layout_sealing_type,
                tube_plate_layout_housings_space =geom.tube_plate_layout_housings_space,
                tube_plate_layout_div_plate_thickness = geom.tube_plate_layout_div_plate_thickness,
                tube_plate_layout_tubeplate_thickness = String.Empty,
                scraping_frequency_tubes_side = geom.scraping_frequency_tubes_side,
                motor_power_tubes_side = geom.motor_power_tubes_side,
                clearances_spacing_tube_to_tubeplate = String.Empty,
                clearances_spacing_tubeplate_to_shell = String.Empty,
                clearances_spacing_division_plate_to_shell = String.Empty,
                clearances_spacing_minimum_tube_hole_to_tubeplate_edge = String.Empty,
                clearances_spacing_min_tube_hole_to_division_plate_groove = String.Empty,
                clearances_spacing_division_plate_to_tubeplate = String.Empty,
                clearances_spacing_minimum_tube_in_tube_spacing = String.Empty
            });
